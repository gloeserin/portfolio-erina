            ...
            >
                ...
                <div className='max-w-full px-4 md:px-12 pt-8 md:pt-32'>
                    <div className='work-container pb-16 md:pb-0'>
                        <p className='max-w-full md:max-w-3/4 mx-auto font-grandSlang text-white text-xl md:text-5xl font-light leading-tight text-center md:text-left'>This project is an automatic transaction application for payment of infaq bills used by all administration and students of SMK Wikrama Bogor.This project is an online library where officers and administrators can upload books and users can borrow automatically.</p>
                        <div className='work-details max-w-full md:max-w-3/4 mx-auto pt-8 md:pt-40'>
                            <div className='flex flex-wrap justify-center md:justify-start'>
                                ...
                                <div className='w-full sm:w-1/3 md:w-auto mb-4 sm:mb-0 gap-6 max-md:ml-5 ml-48'>
                                ...
                                <div className='w-full sm:w-1/3 md:w-auto max-md:ml-5 ml-72'>
